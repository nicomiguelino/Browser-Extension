...
<p align="center">
    <a href="https://github.com/Screenly/Browser-Extension/actions/workflows/build.yaml?query=branch%3Amaster">
        <img alt="GitHub Actions Workflow Status"
            src="https://img.shields.io/github/actions/workflow/status/Screenly/Browser-Extension/build.yaml?label=Build%20Screenly%20Chrome%20Extension&branch=master&style=for-the-badge">
    </a>
